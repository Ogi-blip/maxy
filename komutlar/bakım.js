...
if(!arg) {
  message.reply('Bakım modunu açmak için m-bakım aç yaz')
}
...
message.channel.send(`Botu başarıyla bakıma aldınız, bakımdan çıkarmak için **${ayarlar.prefix}bakım kapat** yazınız.`)
