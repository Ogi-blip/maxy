...
const { GOOGLE_API_KEY } = require("./ayarlar")
...
setInterval(() => {
let değerler =["m-yardım | Beni Sunucunuza Davet Edin", "V0.0.1 #BETA", `${client.guilds.cache.size} Sunucu, ${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kullanıcıya Teşekkür Ederiz.`];
...
client.login(ayarlar.token).then(
  ...
  function(err) {
    console.log("[HATA] Token'de bir hata oluştu: " + err);
